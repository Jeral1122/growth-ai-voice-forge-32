      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-montserrat font-bold">
            ...
            <button 
              ...
              className="bg-neon-green hover:bg-neon-green/90 text-black font-montserrat font-semibold py-3 px-8 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-neon-green/20"
            >
              Get Started
            </button>
          </div>
