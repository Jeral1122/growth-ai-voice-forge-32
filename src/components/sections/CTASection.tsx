      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-r from-charcoal/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 sm:p-12 text-center">
            ...
            <Button onClick={handleGetStrategy} className="bg-neon-green hover:bg-neon-green/90 text-black font-semibold text-lg rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-neon-green/20 group px-[138px] py-[18px] my-0 mx-px">
