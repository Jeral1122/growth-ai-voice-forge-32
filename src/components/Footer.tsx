...
const Footer = () => {
  ...
  return <footer className="bg-charcoal border-t border-gray-800">
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="animate-fade-in opacity-0 [animation-delay:0.4s] [animation-fill-mode:forwards]">
            ...
            <nav className="space-y-2">
              ...
              <button onClick={() => navigate('/demo')} className="block text-gray-400 hover:text-neon-green font-open-sans transition-colors duration-300">Ai Agents</button>
              ...
              <button onClick={() => handleServiceNavigation('/contact')} className="block text-gray-400 hover:text-neon-green font-open-sans transition-colors duration-300">
                Contact
              </button>
            </nav>
          </div>
          ...
          <div className="animate-fade-in opacity-0 [animation-delay:0.8s] [animation-fill-mode:forwards]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 font-open-sans">Info@growthaipro.net</span>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in opacity-0 [animation-delay:1.0s] [animation-fill-mode:forwards]">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6">
            <button onClick={() => navigate('/privacy-policy')} className="text-gray-500 hover:text-neon-green font-open-sans text-sm transition-colors duration-300">
              Privacy Policy
            </button>
            <button onClick={() => navigate('/terms-of-service')} className="text-gray-500 hover:text-neon-green font-open-sans text-sm transition-colors duration-300">
              Terms of Service
            </button>
