        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8 order-2 lg:order-1">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-montserrat font-bold">
                <span className="bg-gradient-to-r from-neon-green via-gold to-neon-green bg-clip-text text-transparent">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-neon-green to-gold text-charcoal px-6 sm:px-8 py-3 sm:py-4 rounded-full font-montserrat font-semibold text-base sm:text-lg hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-neon-green/20 w-full sm:w-auto"
              >
                Get Started
              </button>
            </div>
